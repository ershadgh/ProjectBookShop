...
namespace ProjectBookShop.Migrations
{
    ...
    [Migration("20240910064341_CreateTableInviceAndInvoiceProductAndRelation")]
    partial class CreateTableInviceAndInvoiceProductAndRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectBookShop.Models.ChartData", b =>
                {
            ...
            modelBuilder.Entity("ProjectBookShop.Models.Invoice", b =>
                {
            ...
            modelBuilder.Entity("ProjectBookShop.Models.InvoiceDetails", b =>
                {
                    b.Property<int>("BookID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectBookShop.Models.InvoiceDetails", b =>
                {
                    ...
                    b.HasOne("ProjectBookShop.Models.Invoice", "Invoice")
                        .WithMany("InvoiceDetails")
